        ...
        <h1 className="text-center" data-aos="fade-up">About Me</h1>
          <Row>
            ...
            <Col className="about-text d-flex flex-column justify-content-center" md={6} data-aos="fade-up">
              <p className="text-justify">First of all I want to thanks for your attention. I'm 22 years old and I am a programmer. I like to learn new things about programming from everyone, and anywhere. I'm very passionate in building career in computer field.</p>
