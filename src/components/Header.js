        ...
        <Container>
          <Row className="vh-100">
            <Col lg={7} className="header-text d-flex flex-column justify-content-center" data-aos="fade-right">
              <h1 className="fw-light" data-aos-delay="100"><span>Hello</span>, I'm</h1>
              <h1 data-aos-delay="150">Abram Fernando Haullussy</h1>
              <p data-aos-delay="200">Web Developer</p>
            ...
            <Col lg={5} className="header-pic d-flex align-items-center justify-content-center">
              <div className="image-wrapper" data-aos="fade-up" data-aos-delay="300">
                <Image src={headerPhotoWebp || headerPhoto} />
              </div>
            </Col>
          </Row>
        </Container>
